...
START_TEST(loadCharacters_items001_size_is_correct)
{
#line 154
...
int main(void)
{
    ...
    TCase *tc1_1 = tcase_create("loadCharacters_testcase");
    SRunner *sr = srunner_create(s1);
    int nf;

    suite_add_tcase(s1, tc1_1);
    tcase_add_test(tc1_1, loadCharacters_items001_size_is_correct);
    tcase_add_loop_test(tc1_1, loadItemDetails_items001_items_are_equal, 0, 4);
